...
function eslintTask(options = {}) {
    return function eslint() {
        ...
        if (eslintCmd && eslintConfigPath && fs.existsSync(eslintConfigPath)) {
            ...
            just_task_1.logger.info((0, just_scripts_utils_1.encodeArgs)(eslintArgs).join(' '));
            return (0, just_scripts_utils_1.spawn)(process.execPath, eslintArgs, { stdio: 'inherit', env });
        }
        else {
