...
function jestTask(options = {}) {
    ...
    return function jest() {
        ...
        if (configFileExists) {
            ...
            const packageConfig = (0, just_scripts_utils_1.readPackageJson)(packageConfigPath);
        ...
        if ((configFileExists || packageConfigExists) && jestCmd) {
            ...
            just_task_1.logger.info(cmd, (0, just_scripts_utils_1.encodeArgs)(args).join(' '));
            return (0, just_scripts_utils_1.spawn)(cmd, args, { stdio: 'inherit', env: options.env });
        }
        else {
